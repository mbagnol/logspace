...
\define[flows]
	{\label{def_flow}A flow is an oriented pair written $\,t\flow u\,$ with $\,t,u\in\terms\,$ such that $\,\var(t)=\var(u)\,$.
...
%	\smallskip
	...
	We set $\,1:=x\flow x\,$ and $\,(t\flow u)^\dagger:=u\flow t\,$ so that $\,(.)^\dagger\,$ is an involution of $\,\flows\,$.
	}
...
\define[wirings]
	...
	\[\text{and\quad} \bigg(\sum_i \lambda_i\,l_i\bigg)^\dagger:=\:\sum_i \,\overline\lambda_i\,l_i^\dagger
