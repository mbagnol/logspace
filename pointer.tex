<<<<<<< HEAD
To prove the converse of Theorem \ref{soundness}, we prove that wirings can encode a special kind of read-only multi-head Turing Machines: pointers machines.
=======
