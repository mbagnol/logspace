...
\medskip
Even if unification is knwon to be a \textsc{Ptime}-complete problem, we are concerned in this article with a very much simpler case of the problem: the matching (definition \ref{disjoint}) of linear terms (\textit{ie.} where variables occur at most once).
