...
It takes little effort to see that our pointer machines are just a reasonnable rearrangement of this model, since it is always possible to encode some information in the states.
