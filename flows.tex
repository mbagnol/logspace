...
%	\smallskip
	Flows are considered up to renaming: for any renaming $\,\alpha\,$ we have 
...
\define[wirings]
	{We call \emph{wirings} $\BB C$-linear combinations (formally: almost-everywhere null functions from $\,\flows\,$ to $\,\BB C\,$) of elements of $\,\flows\,$, endowed with:
