...
That acceptation and rejections are \enquote{reversed} is harmless in the deterministic (or equivalently reversible \cite{Lange2000}) case, and uses that {\sc co-NLogspace = NLogspace} \cite{Immerman1988} to get the expected result in the non-deterministic case.
}
