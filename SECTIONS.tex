...
We show how the unification procedure can represent a model of computation by means of specific subalgebras related to finite permutations groups.
We then prove that the complexity of deciding whenever an observation (a program as expressed in this setting) accepts a word can be decided with logarithmic space.
...
\keywords{ Implicit complexity, Geometry of Interaction, proof theory, unification, Logarithmic space, pointer machines} %Proof Theory, ...
