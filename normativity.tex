...
\define[automorphism]
	...
	\[\varphi(FG)=\varphi(F)\varphi(G) \quad \varphi(F^\dagger)=\varphi(F)^\dagger \quad 
...
{\label{indep}If $\,\big((\C \closed)^1,\C B\big)\,$ is a normative pair, $\,W\,$ a word over $\,\Sigma\,$ and $\,F\in \closed\tensor\Sigma\tensor\IO\tensor\C B\,$ an observation, then the application of the observation to the representation of the word $\,FW(t_i)\,$ is nilpotent for one choice of $\,t_i\,$ if and only if it is nilpotent for all choices of $\,t_i\,$.}
