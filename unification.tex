...
The lemma in the article actually states that the problem is in \textsc{NC$^1$}, a complexity class of parallel computation known to be included in \textsc{Logspace}.